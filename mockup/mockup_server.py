...
def transactionPostTransfer():
    return returnFileOnGet("");

@app.route("/v1/transactions/deposit", methods=["POST"])
def transactionDeposit():
    return returnFileOnGet("");

@app.route("/v1/transactions/withdraw", methods=["POST"])
def transactionWithdraw():
    return returnFileOnGet("");

@app.route("/v1/transactions/order", methods=["POST"])
