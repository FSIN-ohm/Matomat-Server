...
-- -----------------------------------------------------
-- Table `matohmat`.`Transaction_Type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `matohmat`.`Transaction_Type` (
...
CREATE TABLE IF NOT EXISTS `matohmat`.`Transactions` (
  ...
  CONSTRAINT `fk_Transactions_Transaction_Type`
    FOREIGN KEY (`Type`)
    REFERENCES `matohmat`.`Transaction_Type` (`short`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
