...
CREATE TABLE IF NOT EXISTS `matohmat`.`users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `auth_hash_UNIQUE` (`auth_hash` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `matohmat`.`transactions` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_transaction_sender_idx` (`sender` ASC),
  INDEX `fk_transaction_recipient_idx` (`recipient` ASC),
...
CREATE TABLE IF NOT EXISTS `matohmat`.`purchase_amount_products` (
  ...
  `id` INT NOT NULL AUTO_INCREMENT,
  INDEX `fk_products_idx` (`products_id` ASC),
...
CREATE TABLE IF NOT EXISTS `matohmat`.`ordered_products` (
  ...
  INDEX `fk_order_has_product_detail_product_detail_idx` (`product_detail_id` ASC),
  INDEX `fk_order_has_product_detail_order_idx` (`order_transaction_id` ASC),
...
GRANT EXECUTE ON ROUTINE `matohmat`.* TO 'matomat_system';
...
START TRANSACTION;
USE `matohmat`;
INSERT INTO `matohmat`.`users` (`id`, `auth_hash`, `balance`, `last_seen`, `name`, `available`) VALUES (1, ..., 0, '0', NULL, DEFAULT);
INSERT INTO `matohmat`.`users` (`id`, `auth_hash`, `balance`, `last_seen`, `name`, `available`) VALUES (2, ..., 0, '0', NULL, DEFAULT);
INSERT INTO `matohmat`.`users` (`id`, `auth_hash`, `balance`, `last_seen`, `name`, `available`) VALUES (3, ..., 0, '0', NULL, DEFAULT);

COMMIT;


-- -----------------------------------------------------
-- Data for table `matohmat`.`admins`
-- -----------------------------------------------------
START TRANSACTION;
USE `matohmat`;
INSERT INTO `matohmat`.`admins` (`id`, `username`, `password`, `email`, `password_salt`, `user_id`) VALUES (1, 'Admin', ..., 'fachsachft-in@th-nuernberg.de', ..., 3);
