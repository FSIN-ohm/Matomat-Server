...
-- -----------------------------------------------------
-- Placeholder table for view `matohmat`.`admin_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `matohmat`.`admin_users` (`id` INT, `username` INT, `email` INT, `password` INT, `password_salt` INT, `user_id` INT, `auth_hash` INT, `balance` INT, `last_seen` INT, `name` INT, `available` INT);
...
-- -----------------------------------------------------
-- View `matohmat`.`admin_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `matohmat`.`admin_users`;
USE `matohmat`;
