...
CREATE TABLE IF NOT EXISTS `matohmat`.`purchase_amount_products` (
  ...
  PRIMARY KEY (`products_id`, `transaction_id`),
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `matohmat`.`products_current` (`prod_id` INT, `price` INT, `name` INT, `image_url` INT, `stock` INT, `available` INT);
