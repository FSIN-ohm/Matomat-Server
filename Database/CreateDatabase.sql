...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `matohmat`.`order_total` (`id` INT, `date` INT, `sender` INT, `recipient` INT, `amount` INT, `buy_cost` INT, `admin_id` INT);
