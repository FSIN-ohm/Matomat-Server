...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `matohmat`.`products_all` (`id` INT, `price` INT, `name` INT, `reorder_point` INT, `image_url` INT, `available` INT, `items_per_crate` INT, `barcode` INT, `valid_from` INT, `product_detail_id` INT);
...
SELECT
    ...
    barcode,
    valid_from,
    products.product_detail_id AS product_detail_id
FROM
    products
        JOIN
    (SELECT
