...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `matohmat`.`order_total` (`id` INT, `date` INT, `sender` INT, `recipient` INT, `amount` INT, `admin_id` INT, `type` INT);
...
BEGIN
  ...
  INSERT INTO matohmat.`order`(transaction_id, buy_cost, admin_id)
